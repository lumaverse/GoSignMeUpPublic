...
Ext.define('Gsmu.TreePicker', {
    ...
    createPicker: function () {
        ...
        var picker = new Ext.tree.Panel(treeConfig),
            view = picker.getView();
    ...
    setValue: function (value) {
        ...
        var display = record ? record.get(me.displayField) : '';
        while (record && record.parentNode) {
            record = record.parentNode;
            var displayValue = (record ? record.get(me.displayField) : '');
